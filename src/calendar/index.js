 ...
 * @example: https://github.com/FatemeMirzaeii/react-native-jalali-calendars/blob/master/example/src/screens/calendars.js
 * @gif: https://github.com/FatemeMirzaeii/react-native-jalali-calendars/blob/master/demo/calendar.gif
 */
class Calendar extends Component {
  ...
  renderDay(day, id) {
    ...
    if (this.props.disabledByDefault) {
      ...
      state = 'disabled';
    } else if (!dateutils.sameMonth(day, this.state.currentMonth, this.props.jalali)) {
      state = 'disabled';
    } else if (dateutils.sameDate(day, XDate())) {
      state = 'today';
    }

    if (!dateutils.sameMonth(day, this.state.currentMonth, this.props.jalali) && this.props.hideExtraDays) {
  ...
  renderWeek(days, id) {
    ...
    return (
      <View style={this.props.jalali ? this.style.rtlWeek : this.style.week} key={id}>
        {week}
      </View>
    );
  }
